        ...
        <footer className="bg-white border-t mt-5 dark:bg-gray-900">
            <div className="mx-auto w-full p-5 ">
                ...
                <li className="mb-4">
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            {items && items.map((item, index) => (
                                ...
                                <li key={index} className="mb-4">
                                    ...
                                    <Link to={`/Collection/${item}`} className=" hover:underline">{item}</Link>
                                </li>
                            ))}
                            {/* <li className="mb-4">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li className="mb-4">
                                <a href="mailTo:contact@thedivastory.com" className="hover:underline">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://digiindiasolutions.com/"> Diva Story By Neetu. All Rights Reserved.</a>
                    </span>
                    <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                        ...
                        <a href="https://www.instagram.com/divastorybyneetu" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className='bg-gray-900 w-full text-center py-2 text-white font-bold'>
                    <h4>Design By <Link target='_blank' to={'https://digiindiasolutions.com/'}>Digi India Solutions</Link></h4>
                </div>
            </div>
        </footer>
