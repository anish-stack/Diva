...
// console.log(formData)
    try {
      ...
      // formDataToSend.append('Para', formData.Para); // Append active
      formDataToSend.append('BtnTitle', formData.BtnTitle); // Append active
  ...
  return (
    <div className="max-w-2xl p-5 min-h-[70ch] border-2 mx-auto mt-8">
      <h1 className="text-2xl font-bold mb-4">Create Offer Banner</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mt-5">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Button Title:</label>
          <input
            type="text"
            name="BtnTitle"
        ...
        {/* <div>
          <label className="block text-sm font-medium text-gray-700">Some Paragraph:</label>
          <textarea
